...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/yusuf-ardiansyah/vultur/master/squid/squid.conf"
...
cd
rm -rf .bashrc
wget https://raw.githubusercontent.com/yusuf-ardiansyah/vultur/master/text%20warna/.bashrc
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/yusuf-ardiansyah/vultur/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by YUSUF-ARDIANSYAH | telegram : @ScriptVps | Pin BBM : yu-suf</pre>" > /home/vps/public_html/index.php
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/yusuf-ardiansyah/vultur/master/conf/vps.conf"
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf

# install openvpn
apt-get install openvpn -y
wget -O /etc/openvpn/openvpn.tar "https://raw.github.com/yusuf-ardiansyah/vultur/master/conf/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/yusuf-ardiansyah/vultur/master/conf/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.conf "https://raw.github.com/yusuf-ardiansyah/vultur/master/conf/iptables.conf"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.github.com/yusuf-ardiansyah/vultur/master/conf/1194-client.conf"
...
#wget "https://raw.githubusercontent.com/yusuf-ardiansyah/vultur/master/dropbear201674/dropbear-2016.74.tar.bz2"
...
# bannerssh
wget "https://raw.githubusercontent.com/yusuf-ardiansyah/vultur/master/menu/bannersshlink.sh"
...
# Install Menu
cd
wget "https://raw.githubusercontent.com/yusuf-ardiansyah/vultur/master/menu/menu"
