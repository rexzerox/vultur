...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/squid/squid.conf"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/conf/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by YusufArdiansyah | telegram : e-Server | Pin BBM : yu-suf</pre>" > /home/vps/public_html/index.php
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/conf/vps.conf"
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf

# install openvpn
apt-get install openvpn -y
wget -O /etc/openvpn/openvpn.tar "https://raw.github.com/deeniedoank/autoscript1/master/conf/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/deeniedoank/autoscript1/master/conf/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.conf "https://raw.github.com/deeniedoank/autoscript1/master/conf/iptables.conf"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.github.com/deeniedoank/autoscript1/master/conf/1194-client.conf"
...
#wget "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/dropbear201674/dropbear-2016.74.tar.bz2"
...
# bannerssh
wget "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/menu/bannersshlink.sh"
...
# auto kill openssh
#wget "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/menu/userlimitssh.sh"
#mv ./userlimitssh.sh /usr/bin/userlimitssh.sh
#chmod +x /usr/bin/userlimitssh.sh

# cranjob
#sudo apt-get install cron
#wget https://raw.githubusercontent.com/deeniedoank/autoscript1/master/clearcache/crontab
#mv crontab /etc/
#chmod 644 /etc/crontab

# tool 
cd
wget -O userlimit.sh "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/menu/userlimit.sh"
wget -O userexpired.sh "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/menu/userexpired.sh"
#wget -O autokill.sh "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/menu/autokill.sh"
wget -O userlimitssh.sh "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/menu/userlimitssh.sh"
...
# clear cache
wget -O clearcache.sh "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/clearcache/clearcache.sh"
#echo "@reboot root /root/clearcache.sh" > /etc/cron.d/clearcache
chmod 755 /root/clearcache.sh

# userlimit
#cd
#wget "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/conf/limits.conf"
...
wget -O speedtest.py "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/menu/speedtest.py"
chmod +x speedtest.py

# Install Menu
cd
wget "https://raw.githubusercontent.com/deeniedoank/autoscript1/master/menu/menu"
...
wget https://raw.githubusercontent.com/deeniedoank/autoscript1/master/ram/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
...
echo "OpenVPN  : TCP Port 55 (client config : http://$myip:8090/1194-client.ovpn)" 
echo "Timezone : Asia/Jakarta"
echo "Fail2Ban : [on]"
echo "Power By : Yusuf Ardiansyah"
echo "PIN BBM  : yu-suf " 
echo "Telegram : e-Server"
echo ""
